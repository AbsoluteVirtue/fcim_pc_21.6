...
Создать таблицу из заданного количества рядов, каждый из которых представлен структурой record.

Созданную таблицу заполнить данными из потока ввода stdin.

В заполненной таблице найти нужный ряд по заданной строке, которая ссылается на фамилию из таблицы.

Отсортировать таблицу по возрастанию относительно поля, хранящего фамилию.

Отсортировать таблицу по убыванию относительно поля, хранящего дату рождения.
